...
variable "proxmox_pve_node_address" {
  type = string
  default = "192.168.123.157"
}

variable "proxmox_pve_api_token" {
  type = string
  default = "terraform-prov@pve!mytoken=2389bc0a-4568-45bc-8374-928cd26a2cda"
}
